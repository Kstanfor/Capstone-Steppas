...
public class Scroll5 : MonoBehaviour
{
    ...
    public GameObject Text5Part1;
    public GameObject Text5Part2;
    ...
    void Start()
    {
        ...
        Text5Part1.SetActive(false);
        Text5Part2.SetActive(false);
