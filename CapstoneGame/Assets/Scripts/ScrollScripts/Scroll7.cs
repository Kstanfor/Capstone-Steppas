...
public class Scroll7 : MonoBehaviour
{
    public GameObject TextBox;
    public GameObject Text7Part1;
    public GameObject Text7Part2;
    ...
    void Start()
    {
        ...
        Text7Part1.SetActive(false);
        Text7Part2.SetActive(false);
